...
NUTRIENT_LABELS = (
    ...
    "fibre", "sodium", "salt", "cholesterol", "calcium", "iron", "potassium",
...
humanize_text = lambda text, do_spellcheck=True: nlp_reconstruct(text, do_spellcheck)["human_readable_text"]
